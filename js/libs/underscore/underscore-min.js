...
(function() {
    ...
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = w), exports._ = w) : n._ = w, w.VERSION = "1.5.0";
    ...
    w.reduce = w.foldl = w.inject = function(n, t, r, e) {
        ...
        t || (t = w.identity);
        var u = !0;
        return null == n ? u : m && n.every === m ? n.every(t, e) : (A(n, function(n, i, a) {
    ...
    var O = w.some = w.any = function(n, t, e) {
        t || (t = w.identity);
        var u = !1;
        return null == n ? u : g && n.some === g ? n.some(t, e) : (A(n, function(n, i, a) {
    ...
    var R = function(n, t, r) {
        return t && w.every(n, w.isArray) ? c.apply(r, n) : (A(n, function(n) {
            w.isArray(n) || w.isArguments(n) ? t ? a.apply(r, n) : R(n, t, r) : r.push(n)
        }), r)
    };
    w.flatten = function(n, t) {
        ...
        return w.unzip.apply(w, o.call(arguments))
    }, w.unzip = function() {
    ...
    var I = function(n, t, r, e) {
        ...
        if ("[object Array]" == u) {
            if (c = n.length, f = c == t.length)
                for (; c-- && (f = I(n[c], t[c], r, e)););
        } else {
            for (var s in n)
                if (w.has(n, s) && (c++, !(f = w.has(t, s) && I(n[s], t[s], r, e)))) break;
            if (f) {
                for (s in t)
                    if (w.has(t, s) && !c--) break;
                f = !c
            }
        }
    ...
    w.template = function(n, t, r) {
        ...
        var u = RegExp([(r.escape || q).source, (r.interpolate || q).source, (r.evaluate || q).source].join("|") + "|$", "g"),
            i = 0,
            a = "__p+='";
