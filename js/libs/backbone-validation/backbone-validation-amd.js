  ...
  Backbone.Validation = (function(_) {
      ...
      var validateAttr = function(model, attr, value, computed) {
        ...
        return _.reduce(getValidators(model, attr), function(memo, validator) {
          ...
          var ctx = _.extend({}, formatFunctions, defaultValidators),
            result;
          if (typeof validator.fn !== 'undefined') {
    ...
    var defaultValidators = Validation.validators = (function() {
      ...
      return {
          ...
          if (_val.length === 3) {
            if (minDate.search(/\//i) < 0) {
              ...
              switch (_minDate) {
                case 'today':
                  _minDate = new Date();
                  minDate = (_minDate.getMonth() + 1) + '/' + _minDate.getDate() + '/' + _minDate.getFullYear()
                  break;
              }
            }
        ...
        // File Type validator
        // Validates file type
        filetype: function(value, attr, values, model) {
          var _ext = value.split('.').pop().toLowerCase();
