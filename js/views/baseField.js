          ...
          if (field.options.confirmed) {
            ...
            var _std_text = field.options.confirmedtext
              ...
              _popoverOptions = {
                ...
                content:
                  '<a class="btn btn-success btn-confirmed" data-href="' +
                  field.url +
            ...
            require(["views/subform-layouts/subbuttons"], function(
              ...
              var subButtonsView = Vm.create(this, _subBtnId, SubButtonsView, {
                ...
                status:
                  that.options.formData && that.options.formData.status
            ...
            $("div#app").on(
              ...
              function(e, view) {
                ...
                $currentBtn.popover({
                  ...
                  trigger: "manual",
                  title:
                    '<span class="text-info">Please complete this form.</span>',
                    ...
                    if (!error) {
                      ...
                      $currentBtn
                        .popover({
                          ...
                          trigger: "manual",
                          title:
                            '<span class="text-info">Sending Information</span>',
                          content:
                            '<div class="text-center subform-button-wrapper"><i class="icon-spinner icon-spin icon-large"></i> Sending</div>'
                        })
                        .addClass("submitted")
                        .popover("show");
                      $currentBtn
        ...
        if (_type === "file" || _type === "image") {
          ...
          if (
            ...
            _html += that.inputTemplate["subform-table"]({
              ...
              heading:
                typeof field.options.readmodedescription === "undefined"
                  ? field.description
    ...
    setupVisibleOn: function(field, htmlTmpl, parentContainer, fieldsType) {
      ...
      if (_shouldAttachedTheVSB) {
        ...
        $(this.el).on("change", _inputNameQ, function(e) {
          ...
          if (DEBUG_VS_ON) {
            console.log(
              "*** Input [" + field.options.visibleon.name + "] changed ***"
            );
          }
          ...
          if (field && field.options && field.options.visibleon) {
            ...
            if (field.options.visibleon.steps) {
              if (
                !_.isArray(field.options.visibleon.steps) ||
            ...
            if ($(".options-visible-on-" + field.name, that.el).length < 1) {
              ...
              $containerOptions = $container
                ...
                .fadeIn("slow", function() {
                  ...
                  if (
                    !that.model.bindings[field.name] &&
                    ...
                    if (
                      $(':input[name="' + _bindingName + '"]').length &&
                ...
                _.each(_addressArray, function(element) {
                  if (that.options.formData.fields[element]) {
                    ...
                    switch (_typeLowerCase) {
                      ...
                      default:
                        if (
                          !($inputTmp.is(":radio") || $inputTmp.is(":checkbox"))
                        ) {
              ...
              if (_typeLowerCase === "userid") {
                ...
                if (
                  !that.model.validation[field.name].pattern &&
                  !(
                    field.options.render &&
                    field.options.render.toLowerCase() === "select"
                  )
              ...
              if (that._hasTime) {
                if (DEBUG) {
                  console.log("[*] baseField.setupVisibleOn - _hasTime");
                  console.log(that.el);
                  console.log(that.$el);
                }
