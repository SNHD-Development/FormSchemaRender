 ...
 **/
define(['jquery', 'lodash', 'backbone', 'vm', 'utils', 'events', 'modelbinder', 'validation', 'views/baseField', 'text!templates/form-layouts/horizontal.html'], function($, _, Backbone, Vm, Utils, Events, Modelbinder, Validation, BaseFieldView, formLayoutTemplate) {
  var AppView = BaseFieldView.extend({
    ...
    render: function() {
      ...
      _.each(visibleOnArray, function(ele) {
        BaseFieldView.prototype.setupVisibleOn.call(that, ele.value, ele.html, '.control-group', fieldsType);
      });
      // Closed open div
